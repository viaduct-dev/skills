---
name: viaduct-mutations
description: |
  Viaduct mutation pattern. Use when creating CRUD operations, handling GlobalID in inputs, using @idOf in input types, or implementing MutationResolvers.
---

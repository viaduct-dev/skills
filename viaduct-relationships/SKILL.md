...
description: |
  Viaduct entity relationship pattern. Use when adding createdBy/owner fields, using nodeFor, referencing other Node types, or creating entity relationships.
---
